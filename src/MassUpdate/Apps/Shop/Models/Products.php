<?php 
namespace MassUpdate\Apps\Shop\Models;
	...
	*/
	public function getOperationGroups(){
		if( $this->needInitialization() ){
    		...
    		->addOperation( new \MassUpdate\Apps\Shop\Operations\Condition\PublicationStatus)
    		->addOperation( new \MassUpdate\Apps\Shop\Operations\Update\PublicationStatus);
